...
public class sandal_categories_layout extends AppCompatActivity {

    private ImageView clickbackView, messView, cartView;

    public void ReceivedComponent(){
        clickbackView = findViewById(R.id.backtocategories_arrow_sandal);
    ...
    public void ClickListener(){
        clickbackView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(sandal_categories_layout.this, categories.class));
            }
        });
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sandal_categories_layout);
