...
public class sneaker_categories_layout extends AppCompatActivity {
    private ImageView clickbackView, messView, cartView;

    public void ReceivedComponent(){
        clickbackView = findViewById(R.id.backtocategories_arrow_sneaker);
    ...
    public void ClickListener(){
        clickbackView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(sneaker_categories_layout.this, categories.class));
            }
        });
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sneaker_categories_layout);
