...
public class boot_categories_layout extends AppCompatActivity {

    private ImageView clickbackView, messView, cartView;

    public void ReceivedComponent(){
        clickbackView = findViewById(R.id.backtocategories_arrow_boot);
    ...
    public void ClickListener(){
        clickbackView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(boot_categories_layout.this, categories.class));
            }
        });
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boot_categories_layout);
