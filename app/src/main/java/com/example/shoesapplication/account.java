...
public class account extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Thay đổi thông tin tài khoản account sau khi đăng ký thành công
//        User user = User.getUser(account.this);
//        if(user!=null) {
//            startActivity(new Intent(this, AccountDDNActivity.class));
//        }
