...
public class categories extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categories.add(new CategoryItem("Sneakers", R.drawable.nike_1));
        categories.add(new CategoryItem("Sandals", R.drawable.sandal));
        categories.add(new CategoryItem("Boots", R.drawable.boott));
        categories.add(new CategoryItem("Stilettos", R.drawable.stiletto));
        categories.add(new CategoryItem("Flats", R.drawable.flatss));
