...
public class ItemAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView productSize = convertView.findViewById(R.id.shoesSize);
        TextView productQuantity = convertView.findViewById(R.id.shoesQuantity);
        ...
        productSize.setText(item.getItemSize());
        productQuantity.setText(item.getItemQuantity());
